...
export const SEED_TECHNIQUES: Technique[] = [
  ...
  T('t-jab-body', 'Jab al corpo', 'JAB AL CORPO', 'boxing', 'Jab al corpo', 'Jab to Body', 'JAB TO BODY', 'Jab to the body'),
  T('t-cross-body', 'Diretto al corpo', 'DIRETTO AL CORPO', 'boxing', 'Diretto al corpo', 'Cross to Body', 'CROSS TO BODY', 'Cross to the body'),
  ...
  T('t-lead-round', 'Calcio sinistro', 'CALCIO SX', 'kicks', undefined, 'Lead Round Kick', 'LEAD ROUND KICK'),
  T('t-rear-round', 'Calcio destro', 'CALCIO DX', 'kicks', undefined, 'Rear Round Kick', 'REAR ROUND KICK'),
  ...
  T('t-lead-knee', 'Ginocchio laterale sinistro', 'GINOCCHIO LATERALE SX', 'knees', 'Ginocchio laterale dal clinch', 'Lead Knee', 'LEAD KNEE', 'Side knee from clinch'),
  T('t-rear-knee', 'Ginocchio laterale destro', 'GINOCCHIO LATERALE DX', 'knees', 'Ginocchio laterale dal clinch', 'Rear Knee', 'REAR KNEE', 'Side knee from clinch'),
  ...
  T('t-horizontal-elbow', 'Gomito laterale', 'GOMITO LATERALE', 'elbows', 'Gomito orizzontale', 'Horizontal Elbow', 'HORIZONTAL ELBOW'),
